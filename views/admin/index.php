...
<head>
    ...
    <title>Admin - Module Dashboard</title>
    <meta
    ...
    <link
        ...
        href="../../assets/img/diprojectin/favicon.ico"
        type="image/x-icon" />
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="module">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="views/list_module.php">
                                            <span class="sub-item">List Module</span>

                                        </a>
                                    </li>
                                    <li>
                                        <a href="views/add_module.php">
                                            <span class="sub-item">Add Module</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="views/manage_module.php">
                            ...
                            <div class="card card-stats card-round">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col col-stats ms-3 ms-sm-0">
                                            <div class="numbers">
                                                <p class="card-category">Total Modules</p>
                                                <h4 class="card-title">1,294</h4>
                                            </div>
                                        </div>
                                    </div>
